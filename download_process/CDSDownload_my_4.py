...
#     try:
#         download_era5_variable_year(variable, 1984)
#     except Exception as e:
#         print(f"❌ Failed: {variable}_{1984}. Error: {e}")
#         continue
# print('1984年数据下载完成!')
...
print('下载1984年2m_dewpoint_temperature数据...')
try:
    download_era5_variable_year('2m_dewpoint_temperature', 1984)
except Exception as e:
    print(f"❌ Failed: 2m_dewpoint_temperature_1984. Error: {e}")
print('1984年2m_dewpoint_temperature数据下载完成!')
